    ...
    <Card>
      <CardContent className="p-4 sm:p-6">
        <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-center">
          <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 bg-gray-200 rounded-md flex items-center justify-center text-2xl sm:text-3xl md:text-7xl font-bold text-green-700 flex-shrink-0 overflow-hidden">
            ...
            <div className={`w-full h-full flex items-center justify-center ${profile.profilePhoto ? "hidden" : "flex"}`}>
