...
export default function AdminDashboard() {
  ...
  // Dummy data untuk grafik - nanti akan diganti dengan data real dari API
  ...
  const categoryData = {
    labels: ["Elektronik", "Dokumen", "Aksesori", "Pakaian", "Lainnya"],
    datasets: [
      {
        ...
        borderColor: ["rgba(59, 130, 246, 1)", "rgba(34, 197, 94, 1)", "rgba(234, 179, 8, 1)", "rgba(239, 68, 68, 1)", "rgba(168, 85, 247, 1)"],
        borderWidth: 2,
      },
    ],
  };
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <Card className="lg:col-span-2">
          <CardContent className="pt-6">
            <h3 className="font-semibold mb-4 text-gray-700">Tren Bulanan Barang Temuan</h3>
            <div className="h-72">
              <Line
        ...
        <Card>
          <CardContent className="pt-6">
            <h3 className="font-semibold mb-4 text-gray-700">Distribusi Status</h3>
      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          <h3 className="font-semibold mb-4 text-gray-700">Distribusi Barang per Kategori</h3>
          <div className="h-80">
            <Bar
              data={categoryData}
        ...
        activities={[
          {
            ...
            description: "Laporan tentang barang hilang baru saja diterima.",
